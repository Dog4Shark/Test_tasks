//
// Ќа рынок было приглашено N продавцов с пирогами, каждый должен 
// был принести заранее заданное количество пирогов.  сожалению 
// один продавец не пришел.–аспечатайте по возрастанию все возможные 
// варианты суммарного количества пирогов на рынке(C++ 17) :
// 
// ѕример ввода :
// 10 5 2 7 1 4 4 3 2 1 9
// ѕервое число 10 Ц количество торговцев, далее идет сколько 
// каждый из них должен был принести пирогов.
//
